...
#let (spec, scope) = process-spec((
  ...
  big: define-cmd(1, handle: it => scale(x: 120%, y: 120%, move(dy: -0.05em, it))),
  Big: define-cmd(1, handle: it => scale(x: 180%, y: 180%, move(dy: -0.05em, it))),
  bigg: define-cmd(1, handle: it => scale(x: 240%, y: 240%, move(dy: -0.05em, it))),
  Bigg: define-cmd(1, handle: it => scale(x: 300%, y: 300%, move(dy: -0.05em, it))),
